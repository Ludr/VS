...
import rmi.consumer.*;
import rmi.leapmotion.LeapGui;
import rmi.leapmotion.LeapMotionController;
...
public class ConsumerStub implements IIDL {
	...
	private String marshall(Integer percent) {
		...
		params.robotName = LeapMotionController.currentRobotString;// GuiUpdater.getInstance().getSelectedRobot();
